...
Repositorio personal de la materia Data Mining de la [Maestría en Ciencia de Datos](https://www.itba.edu.ar/posgrado/especializacion-en-ciencia-de-datos/ "MCD Homepage") del [Instituto Tecnológico de Buenos Aires](https://www.itba.edu.ar/ "ITBA Homepage"). 

Este repositorio contiene material, recursos y proyectos relacionados con la materia. Aquí encontrarás información sobre las clases, ejercicios, proyectos y enlaces útiles para aprender y profundizar tus conocimientos en Machine Learning.
...
Este repositorio se distribuye bajo la licencia "Creative Commons Attribution 4.0 International". Consultar [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) para obtener más detalles.